  ...
  Future<void> _submitForm() async {
    if (_formKey.currentState!.validate()) {
      ...
      try {
        if (_isLogin) {
          ...
          if (user != null) {
            if (_selectedImage != null) {
              final storageRef = _storage.ref().child('users/profile_pictures/${user.uid}.jpg');
        ...
        Navigator.of(context).pushReplacement(MaterialPageRoute(builder: (context) => const TeacherDashboard()));
                      ...
                      children: [
                        ...
                        if (!_isLogin) ...[
                          ...
                          _buildTextField(
                              ...
                              hintText: 'e.g., Algebra I, World History',
                              icon: Icons.class_),
                          const SizedBox(height: 16),
                        ],
                        _buildTextField(
                        ...
                        TextButton(
                          onPressed: _isLoading
                            ...
                            setState(() {
                              ...
                              _formMessage = null; // Clear previous messages
                            });
                          },
                          child: Text(
                              _isLogin
  ...
  Widget _buildTextField({
    ...
    return TextFormField(
      ...
      decoration: InputDecoration(
        ...
        prefixIcon: icon != null ? Icon(icon, color: const Color(0xFF26C6DA)) : null,
      ...
      validator: (value) =>
      (value == null || value.isEmpty) ? 'Please enter your $labelText.' : null,
    );
  }
