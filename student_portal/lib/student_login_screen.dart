        ...
        if (_isLogin) {
          ...
          if (user != null) {
            ...
            await _firestore.collection('users').doc(user.uid).set({
              ...
              'studentId': user.uid, // Automatically added student ID
              'enrollmentDate': FieldValue.serverTimestamp(), // Automatically added enrollment date
            });
          }
        }
                ...
                child: Padding(
                  ...
                  child: Form(
                    ...
                    child: Column(
                      ...
                      children: [
                        Text(_isLogin ? 'Student Login' : 'Create Student Account',
